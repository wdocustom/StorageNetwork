...
const TOPIC_PRESETS = [
  ...
  { label: "Adirondack Chair", value: "Focus on the handmade Low Boy Adirondack Chair. Built from solid lumber with a classic low-slung Adirondack profile — great for patios, backyards, garages, or workshops. This is a natural upsell when customers are already getting a storage system: they're fixing up the garage anyway, why not add a piece they'll actually sit in? Handmade by the same installer. Highlight the craftsmanship and the fact that it's a one-of-a-kind piece, not something from a box store." },
