...
const TESTIMONIALS: Testimonial[] = [
  ...
  },
  {
    ...
    initials: "MF",
    text: "When you\u2019re doing three to five installs a day, you physically do not have time to play phone tag, explain dimensions, or spend three hours every night writing up manual quotes. The admin work was the absolute bottleneck holding my business back. Moving my operation to this platform put my entire front-end on autopilot. Homeowners hit my link, use the 3D visualizer to build exactly what they want, and pay the deposit right there. Or if I absolutely need to, I\u2019ll use a AI tool to build a quick quote in seconds that pulls my pricing and I sent the customer their quote link so the next morning I can just wake up, look at the dashboard to see my fully-paid deposits and schedule for the day, build and load the truck. It\u2019s like having a full-time office manager and a 24/7 sales guy built into my phone. I\u2019ve been able to maximize my daily job volume without adding a single minute of office work to my plate.",
  },
];
