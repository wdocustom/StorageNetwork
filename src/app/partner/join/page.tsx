...
function PartnerJoinPageInner() {
  ...
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      {/* ══════════════════════════════════════════════════════════════════
          PLATFORM FEATURES — PRODUCTS & TOOLS
      ══════════════════════════════════════════════════════════════════ */}
      <section className="relative overflow-hidden border-t border-slate-800 bg-slate-950 px-6 py-20 lg:py-28">
        <div className="pointer-events-none absolute right-0 top-0">
          <div className="h-[400px] w-[400px] rounded-full bg-yellow-400/[0.03] blur-[100px]" />
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-2xl border border-slate-800 bg-slate-900/50 p-6">
              ...
              <p className="mb-4 text-sm leading-relaxed text-stone-400">
                ...
                Multiple size configurations, full 3D preview, and auto-generated material lists.
              </p>
              <div className="space-y-2">
                {["Multiple size configurations", "3D configurator support", "Auto-generated cut plans", "Combine with tote units"].map((item) => (
            ...
            <div className="rounded-2xl border border-slate-800 bg-slate-900/50 p-6">
              ...
              <p className="mb-4 text-sm leading-relaxed text-stone-400">
                Maximize dead space above vehicles. Customers configure width, depth, and drop height
                in the design tool. Full 3D visualization and auto-calculated materials.
              </p>
              <div className="space-y-2">
                {["Custom width, depth & drop height", "Ceiling-mounted 3D preview", "Full material & hardware lists", "High-margin upsell opportunity"].map((item) => (
                  <div key={item} className="flex items-center gap-2 text-xs text-stone-400">
                    <CheckCircle2 className="h-3.5 w-3.5 shrink-0 text-emerald-400" />{item}
                  </div>
                ))}
            ...
            <div className="rounded-2xl border border-slate-800 bg-slate-900/50 p-6">
              ...
              <p className="mb-4 text-sm leading-relaxed text-stone-400">
                ...
                finish, depth, and pest protection. High-margin seasonal product.
              </p>
              <div className="space-y-2">
                {["8 sizes with 4 finish options", "4 pest protection cover styles", "3D preview + instant pricing", "Custom installer pricing controls"].map((item) => (
                  <div key={item} className="flex items-center gap-2 text-xs text-stone-400">
                    <CheckCircle2 className="h-3.5 w-3.5 shrink-0 text-emerald-400" />{item}
                  </div>
                ))}
            ...
            <div className="rounded-2xl border border-slate-800 bg-slate-900/50 p-6">
              ...
              <p className="mb-4 text-sm leading-relaxed text-stone-400">
                ...
                to catalog what&apos;s in every tote &mdash; AI identifies contents instantly. Drives repeat business.
              </p>
              <div className="space-y-2">
                {["AI-powered photo scanning", "Organization score & tracking", "Built-in referral engine", "Always free for customers"].map((item) => (
                  <div key={item} className="flex items-center gap-2 text-xs text-stone-400">
                    <CheckCircle2 className="h-3.5 w-3.5 shrink-0 text-emerald-400" />{item}
                  </div>
                ))}
            ...
            <div className="rounded-2xl border border-slate-800 bg-slate-900/50 p-6">
              ...
              <p className="mb-4 text-sm leading-relaxed text-stone-400">
                Collect verified reviews from real customers, tied to actual paid jobs.
                Reviews display on your portfolio with star ratings and a Verified badge.
              </p>
              <div className="space-y-2">
                {["One-click request or copy link", "No customer login required", "Quick-tap tags: Professional, On Time, etc.", "Portfolio showcase with rating summary"].map((item) => (
                  <div key={item} className="flex items-center gap-2 text-xs text-stone-400">
                    <CheckCircle2 className="h-3.5 w-3.5 shrink-0 text-emerald-400" />{item}
                  </div>
                ))}
        ...
        <div className="relative mx-auto max-w-6xl">
          <div className="flex flex-col items-center gap-12 lg:flex-row lg:items-start lg:gap-16">
            <div className="lg:w-[55%]">
              <div className="mb-3 flex items-center gap-2">
                <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-yellow-400">Auto-Marketing</p>
                <span className="rounded bg-yellow-400/15 px-2 py-0.5 text-[9px] font-black uppercase tracking-wider text-yellow-400 ring-1 ring-yellow-400/30">Coming Soon</span>
              </div>
              <h2 className="mb-4 text-3xl font-black leading-[1.1] tracking-tight text-white xl:text-4xl">
                The Platform{" "}
                <span className="bg-gradient-to-r from-yellow-300 to-yellow-500 bg-clip-text text-transparent">Markets For You.</span>
              </h2>
              <p className="mb-6 max-w-md text-base leading-relaxed text-stone-400">
                ...
                think about where your next customer comes from.
              </p>
              <div className="mb-6 rounded-xl border border-emerald-400/20 bg-emerald-400/[0.03] p-4">
                ...
                <p className="mt-1 text-xs leading-relaxed text-stone-500">
                  Thousands of SEO-optimized landing pages are already live, funneling homeowners
                  searching for garage storage directly to local installers on the platform.
                </p>
              </div>
              <div className="space-y-4">
                {[
                  { icon: Megaphone, title: "Instagram Post Generator", desc: "Auto-generates complete posts with captions, hashtags, and content direction." },
                  { icon: BarChart3, title: "Full Marketing Strategy", desc: "A planned-out content calendar tailored to your local market." },
                  { icon: Globe, title: "Nationwide SEO Pages", desc: "Auto-generated city pages that rank in Google and drive organic traffic." },
                ].map((item) => (
                  <div key={item.title} className="flex gap-3">
                    <div className="mt-1 flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-xl bg-yellow-400/10 ring-1 ring-yellow-400/20">
                      <item.icon className="h-4 w-4 text-yellow-400" />
            ...
            <div className="lg:w-[45%]">
              <div className="rounded-2xl border border-yellow-400/20 bg-gradient-to-br from-yellow-400/5 to-slate-900 p-8 shadow-2xl shadow-yellow-400/5">
                <div className="mb-6 flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[11px] font-bold uppercase tracking-widest text-yellow-400/60">Auto-Marketing</p>
                    <p className="text-xl font-black text-white">Zero Effort Growth</p>
                  </div>
                </div>
                <div className="space-y-3">
                  {[
                    { step: "1", text: "Platform auto-generates city pages that rank in Google" },
                    { step: "2", text: "Homeowners find their local page and design their system" },
                    { step: "3", text: "They get matched with you — confirmed job with deposit paid" },
                    { step: "4", text: "AI generates your social media posts for even faster growth" },
                  ].map((item) => (
                    <div key={item.step} className="flex items-start gap-3 rounded-lg border border-slate-700/50 bg-slate-800/50 p-3">
                      <div className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full bg-yellow-400 text-xs font-black text-gray-950">{item.step}</div>
                ...
                <div className="mt-6 rounded-lg border border-yellow-400/20 bg-yellow-400/5 p-3 text-center">
                  <p className="text-xs font-bold text-yellow-400">You build. The platform brings the customers.</p>
                </div>
              </div>
            </div>
          </div>
