...
export default async function InstallerPortfolioPage({ params }: PageProps) {
  ...
  const hasSocials = hasPhone || hasInstagram || hasFacebook;
    ...
    <div className="min-h-screen bg-[#080c16]">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-3xl px-4 pb-8 pt-10 sm:pt-14">
          <div className="flex flex-col items-center text-center">
            ...
            {location && (
              <p className="mb-4 flex items-center gap-1.5 text-sm text-stone-400">
              ...
              <div className="flex flex-wrap items-center justify-center gap-2.5">
                {hasPhone && (
                  <a
                    ...
                    className="inline-flex items-center gap-2 rounded-xl border border-slate-700 bg-slate-800/80 px-4 py-2.5 text-sm font-semibold text-white transition-all hover:border-yellow-400/40 hover:bg-slate-800"
                  >
                ...
                {hasInstagram && (
                  <a
                    ...
                    className="inline-flex items-center gap-2 rounded-xl border border-slate-700 bg-slate-800/80 px-4 py-2.5 text-sm font-semibold text-white transition-all hover:border-pink-400/40 hover:bg-slate-800"
                  >
                ...
                {hasFacebook && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 rounded-xl border border-slate-700 bg-slate-800/80 px-4 py-2.5 text-sm font-semibold text-white transition-all hover:border-blue-400/40 hover:bg-slate-800"
                  >
      ...
      {hasBio && (
        <section className="mx-auto max-w-3xl px-4 pb-8">
          <div className="rounded-2xl border border-slate-800/60 bg-[#0d1220] p-6">
          ...
          <div className="relative p-6 sm:p-8">
            <div className="mx-auto max-w-md text-center">
              ...
              <p className="mb-6 text-sm text-stone-400">
                ...
                Get instant pricing, a detailed cut list, and professional installation.
              </p>
