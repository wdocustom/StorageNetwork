...
export const metadata: Metadata = {
  ...
  description:
    "Start building tote storage systems for pre-sold customers. Free trial — 3 jobs, no credit card. Automated cut plans, Stripe payouts, branded portfolio page, AI marketing tools, and exclusive territory.",
  keywords: [
