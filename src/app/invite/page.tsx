...
const NEW_WAY = [
  ...
  { icon: CheckCircle2, text: "Tiered priority — more experience and Pro status means more jobs" },
];
...
const STEPS = [
  {
    ...
    icon: User,
    title: "Sign Up",
    desc: "Set up your service area. Takes 30 seconds. No credit card.",
  },
  {
    num: "02",
    icon: Hammer,
...
const FAQS = [
  ...
  {
    q: "What if there are other installers in my area?",
    a: "Multiple installers can serve the same area. Jobs are routed via tiered priority — Pro status, experience, and availability determine who gets each lead. More installers in a region means more marketing investment and more total customers.",
  },
  {
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              },
              {
                ...
                image: "/invite/cut-list-preview.jpg",
                caption:
              ...
              >
                <div className="relative aspect-video overflow-hidden bg-gradient-to-br from-stone-950 to-gray-900">
                  <Image
                    src={card.image}
                    alt={card.title}
                    fill
            ...
            <div className="space-y-4">
              ...
              >
                {loading ? (
                  ...
                  <>
                    Start Getting Jobs — 3 Jobs Free
