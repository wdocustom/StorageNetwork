...
- **Garage Cleanout Services**: Built-in cleanout services — 1-car, 2-car, 3+ car garage cleanouts with custom pricing. Customers can add a cleanout to their storage order or book standalone.
- **DIY Plan Downloads**: Customers who want to build themselves can buy DIY cut plans for $19. Pro subscribers get free access. Additional revenue stream.
- **Discount Codes**: Create promo codes with percentage or fixed discounts, max uses, expiration dates. Great for promotions or repeat customers.
- **Analytics Dashboard**: See page views, visitors, device breakdown, traffic sources, and conversions at /dashboard/analytics.
- **Sales Insights / CRM**: Full sales dashboard at /dashboard/sales — completed orders, customer cards, revenue summary, popular unit rankings.
- **Installer Leaderboard**: Monthly rankings of top performers by revenue and completed jobs. Friendly competition.
- **Demand Signals**: The platform tracks customer demand in uncovered areas. New installers in high-demand ZIPs can get jobs from day one because waitlisted customers are auto-notified.
